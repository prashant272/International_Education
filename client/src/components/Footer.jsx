        ...
        <PageHero compact={true}>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 py-8 sm:py-16 md:py-20">
            ...
            ">
              ...
              <section className="flex flex-col h-full items-start gap-x-4" aria-label="About Us">
                ...
                <div
                  className="mt-3 rounded-full h-1 w-24 bg-gradient-to-r from-transparent via-indigo-500 to-transparent mb-4"
                />
          ...
          <div className="gap-2 mt-4 flex justify-start sm:justify-center pb-8 px-5">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-indigo-500/30 bg-indigo-500/5 hover:border-indigo-500/80 hover:bg-indigo-500/10 transition-all duration-300 shadow-lg shadow-indigo-500/5"
            >
              <span className="text-[10px] text-slate-400 tracking-wider font-medium">
                ✦ Designed &amp; Developed by
              </span>
              <span className="text-[12px] font-bold tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-indigo-400">
