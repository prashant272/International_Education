...
export default function MediaGallery() {
  ...
  const reels = useMemo(() => [
    { url: "https://www.youtube.com/watch?v=A4TkdJNLXlw&list=PLDcK2rcehryaRGEWEo0Se1WWi_YoB4Ifb&index=23" },
    { url: "https://www.youtube.com/watch?v=Og69GhWHuKQ" },
    { url: "https://www.youtube.com/watch?v=LDTwlvNwfrY" },
    { url: "https://www.youtube.com/watch?v=BgdZV18SLAE" },
  ...
  const photos = useMemo(() => [
    '2022/1.jpg', '2022/2.jpg', '2022/3.jpg', '2022/4.jpg',
  ...
  const videos = useMemo(() => [
    { url: "https://www.youtube.com/watch?v=MBoNTrPLeZI&t=877s" },
    { url: "https://www.youtube.com/watch?v=yaFT7MPXbrM" },
    { url: "https://www.youtube.com/watch?v=Og69GhWHuKQ&t=1s" },
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <FadeUp className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl xs:text-4xl md:text-5xl font-heading font-black mb-4 bg-gradient-to-r from-white via-indigo-400 to-white bg-clip-text text-transparent drop-shadow-2xl">
            Media <span className="text-indigo-400">Gallery</span>
          </h2>
