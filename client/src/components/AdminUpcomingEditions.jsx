                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input required className={inputClass} value={formData.title} onChange={e => setFormData({ ...formData, title: e.target.value })} placeholder="Global Education Awards 2026" />
                                    </div>
                                </div>
