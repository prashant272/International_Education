...
const categoryMap = {
  "Educational Institutions": {
    ...
    "Higher Education": [
      ...
      "Outstanding Higher Education Institution",
    ],

    "Skill & Vocational Education": [
      "Best Skill Development Institute",
      "Best Vocational Training Organisation",
      "Excellence in Professional Education",
      "Best Career Development Institute",
  ...
  "Leadership & Academic Excellence": {
    "Institutional Leadership": [
      ...
      "Transformational Education Leader",
    ],
    ...
    "Teaching Excellence": [
      ...
      "Best Mentor in Education",
    ],

    "Women & Young Leaders": [
      "Women Education Leader of the Year",
      "Young Educator of the Year",
      "Emerging Academic Leader",
  ...
  "EdTech & Innovation": {
    "EdTech Excellence": [
      ...
      "Most Innovative EdTech Platform",
      "Best Learning Management System",
      "Best Online Education Platform",
      "Best AI-Driven Learning Solution",
    ],

    "Innovation in Education": [
      "Innovation in Digital Learning",
      "Best Smart Classroom Initiative",
      "Excellence in STEM Education",
      "Best Research & Innovation Initiative",
      "Future-Ready Education Award",
    ],

    "Emerging Technologies": [
      "Best AI in Education Initiative",
      "Best Virtual Learning Platform",
      "Excellence in Educational Technology Adoption",
      "Best Hybrid Learning Model",
      "Most Innovative Education Startup",
    ],
  },
  ...
  "Student Development & Inclusion": {
    "Student Success": [
      ...
      "Best Career Guidance Initiative",
      "Best Student Support Programme",
      "Outstanding Placement Record Award",
      "Best Entrepreneurship Development Programme",
    ],

    "Inclusive Education": [
      "Excellence in Inclusive Education",
      "Best Special Education Initiative",
      "Women Empowerment in Education Award",
      "Rural Education Development Award",
  ...
  "Research & Academic Innovation": {
    ...
    "Academic Programmes": [
      ...
      "Best International Collaboration Programme",
      "Outstanding Academic Programme",
      "Excellence in Experiential Learning",
    ],
  },

  "Sector-Specific Education Excellence": {
    "School & K-12 Education": [
      "Best Preschool of the Year",
      "Best K-12 Institution",
      "Best School for Digital Learning",
      "Best Co-Curricular Education Programme",
      "Best Value-Based Education Institution",
    ],

    "Professional Education": [
      "Best Engineering Education Institution",
      "Best Medical Education Institution",
      "Best Law Education Institution",
      "Best Business School",
      "Best Design & Creative Arts Institution",
    ],

    "Coaching & Test Preparation": [
      "Best Coaching Institute",
      "Best UPSC Coaching Institute",
      "Best NEET / JEE Preparation Institute",
      "Best Online Coaching Platform",
      "Outstanding Competitive Exam Training Institute",
    ],

    "Global & International Education": [
      "Best International Education Provider",
      "Global Education Excellence Award",
      "Outstanding International Collaboration in Education",
...
const initialForm = {
  nominationType: "internationalEducation",
  ...
  return (
    <PageHero
      ...
      subtitle={isEditMode
        ...
        : "Salute the educators, crown the changemakers. Nominate yourself or your institution for ultimate educational excellence award"
      }
    >
