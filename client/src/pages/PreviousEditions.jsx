      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-32">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20  gap-4">
            ...
            <p className="text-sm font-bold tracking-widest uppercase animate-pulse text-indigo-300">Synchronizing Archives...</p>
          </div>
        ) : editions.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="h-60 relative overflow-hidden">
                        {edition.images && edition.images.length > 0 ? (
                          ...
                          <div className="w-full h-full bg-indigo-950/30 flex items-center justify-center text-5xl">🏆</div>
                        )}
                      ...
                      <div className="p-8 text-left">
                        <p className="text-[10px] text-indigo-400 font-black uppercase tracking-[0.3em] mb-3">
                          {edition.editionLabel || "Previous Edition"}
                        </p>
                        <h3 className="text-2xl font-black text-white leading-tight uppercase mb-4 group-hover:text-indigo-400 transition-colors">
                          {edition.title}
                        </h3>
                        ...
                        <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-500/60 group-hover:text-indigo-400">View Archive</span>
                          <div className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center group-hover:bg-indigo-500 group-hover:text-[#020817] transition-all">
          ...
          <div className="text-center py-20">
            <p className="text-indigo-100/40 font-black uppercase tracking-widest">No editions found in the archive.</p>
          </div>
        )}
      </div>
