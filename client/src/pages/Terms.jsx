  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="By submitting a nomination for the International Education Award, 2026, the nominee and/or nominator agrees to the following terms and conditions."
      >
        {/* Terms Grid */}
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <FadeUp delay={0.4} className="mt-12 glass-card border border-indigo-400/20 p-6 md:p-8 text-center animate-border-glow">
            ...
            <p className="text-indigo-100/70 text-sm md:text-base leading-relaxed max-w-2xl mx-auto italic">
              By participating in the International Education Award, 2026, you acknowledge that you have read, understood, and agree to all the above Terms & Conditions.
            </p>
          </FadeUp>
        </div>
      </PageHero>
