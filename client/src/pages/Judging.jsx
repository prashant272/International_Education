  ...
  return (
    <>
      <PageHero
        ...
        subtitle="A multi-stage, transparent, and fair evaluation framework — recognising only the most deserving organisations and individuals across international education."
      >
        {/* Timeline Steps */}
        ...
        <FadeUp delay={0.3} className="mt-10 glass-card border border-indigo-500/15 p-6 md:p-8 text-center">
          ...
          <p className="text-indigo-100/70 leading-relaxed max-w-2xl mx-auto">
            Our rigorous and transparent selection process ensures awards are merit-based, truly credible, and that every winner enjoys international trust and respect in the international education industry.
          </p>
        </FadeUp>
      </PageHero>
    </>
