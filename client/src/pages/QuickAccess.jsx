 ...
 * 2. Delay Trigger: When visiting the site, it waits for exactly 15 seconds before showing up.
 * 3. Close & Nudge Recycle: If a user closes the modal (by clicking "X"), it is hidden
 *    temporarily, but automatically pops up again after a 15-second delay until they successfully verify.
 */
